    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <section class="content-header">
                    <h1 class="pull-right">
                        ...
                        <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px;" href="{!! route('asignar-encuestas.agregar-detalle-contacto', [$contacto->id, $entrevista->id]) !!}">Nueva información</a>
                    </h1>
                </section>
                <div class="content">
            ...
            <div class="modal-footer">
                ...
                <a href="{!! route('asignar-encuestas.modificar-contacto-entrevista', [$contacto->id, $entrevista->id]) !!}" class="btn btn-primary pull-right">Editar información</a>
            </div>
        </div>
    <!-- /.modal-content -->
    </div>
