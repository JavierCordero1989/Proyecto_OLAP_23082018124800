...
@section('content')
                    ...
                    <div class="dropdown">
                        <button class="btn btn-default dropdown-toggle col-sm-12" type="button" id="dropdownEnlacesInfoContacto" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownEnlacesInfoContacto">
                                ...
                                @endforeach
                                <li><a href="{!! route('asignar-encuestas.agregar-contacto-entrevista', $entrevista->id ) !!}">Agregar contacto</a></li>
                            </ul>

                            <!-- Se agregan los modales mediante un foreach -->
                            @foreach($entrevista->contactos as $contacto) 
                                @include('encuestadores.modal_info_de_contacto')
                            @endforeach
                    </div>
                </div>
            </div>
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    {!! Form::model($entrevista, ['route' => ['asignar-encuestas.actualizar-entrevista', $entrevista->id], 'method' => 'patch', 'onsubmit'=>'return revisar_estado();']) !!}
                        ...
                        <div class="form-group col-sm-6 col-sm-offset-3">
                            ...
                            <a href="{!! route('asignar-encuestas.lista-encuestas-asignadas', Auth::user()->id) !!}" class="btn btn-default col-sm-4 col-sm-offset-4">Cancelar</a>
                        </div>
                    {!! Form::close() !!}
                </div>
            </div>
