...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    {!! Form::open(['route' => ['asignar-encuestas.guardar-contacto-entrevista-supervisor', 'id_entrevista'=>$id_entrevista, 'id_supervisor'=>Auth::user()->id], 'id'=>'form-nuevo-contacto', 'class'=>'form-horizontal']) !!}
