    ...
    <div class="content">
        ...
        <div class='box box-primary'>
            <div class='box-body with-border'>
                {!! Form::model($detalle, ['route'=>['contactos.editar-detalle-contacto-post', $entrevista->id, $detalle->id], 'method' => 'patch']) !!}
                    ...
                    <div class="col-md-6 col-md-offset-3 form-group">
                        ...
                        {!! Form::select('estado', [''=>'Elija el estado', 'F'=>'Funcional', 'E'=>'Eliminado'], null, ['class'=>'form-control', 'required']) !!}
                    </div>
