...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    {!! Form::open(['route' => ['contactos.guardar-contacto-post', $entrevista->id], 'id'=>'form-nuevo-contacto', 'class'=>'form-horizontal']) !!}
                        
                        <!-- Campo para la identificacion de la referencia -->
                        <div class="form-group">
                            {!! Form::label('identificacion_referencia', 'Identificación de la referencia: ', ['class'=>'control-label col-md-4']) !!}
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-md-6 inputGroupContainer'>
                                <div class='input-group'>
                                    ...
                                    <textarea class='form-control' name="observacion_contacto" id="observacion_contacto" cols="2" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-md-6 inputGroupContainer'>
                                <div class='input-group'>
                                    <button type="submit" class='btn btn-primary' style="margin-right:15px;">Guardar</button>
