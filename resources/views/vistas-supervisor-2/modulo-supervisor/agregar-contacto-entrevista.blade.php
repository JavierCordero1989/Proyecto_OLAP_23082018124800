...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    {!! Form::open(['route' => ['supervisor2.guardar-contacto-entrevista-supervisor', 'id_entrevista'=>$id_entrevista, 'id_supervisor'=>Auth::user()->id], 'onsubmit'=>'return validar_campos();']) !!}
