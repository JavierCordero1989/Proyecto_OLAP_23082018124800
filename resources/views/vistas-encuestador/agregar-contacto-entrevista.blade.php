...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    {!! Form::open(['route' => ['encuestador.guardar-contacto-entrevista-encuestador', 'id_entrevista'=>$id_entrevista, 'id_encuestador'=>Auth::user()->id],'onsubmit'=>'return validar_campos();']) !!}
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <a href="{!! route('encuestador.realizar-entrevista', $id_entrevista) !!}" class="btn btn-default">Cancelar</a>
                        </div>
