...
<body>
    <article class="starwars">
        <audio preload="auto">
            <source src="sounds/Star_Wars_original_opening_crawl_1977.ogg" type="audio/ogg" />
            <source src="sounds/Star_Wars_original_opening_crawl_1977.mp3" type="audio/mpeg" />
        ...
        <div class="animation">
            ...
            <section class="intro">
                Los siguientes agradecimientos son para...
            ...
            <section class="titles">
                <div>  
                    <p>
                        A Olman Madrigal, quien decidió abrir la oportunidad
                        de la práctica empresarial; por contribuir siempre
                        en mi desempeño como estudiante e impulsarme a aprender
                        algo nuevo todos los días y superarme siempre.
                    </p>
                
                    <p>
                        A Cinthia Azofeifa, por ser una compañera de oficina
                        con excelentes vibras de cero estrés, además de estar
                        siempre anuente a todas mis preguntas con una grandiosa
                        amabilidad.
                    </p>
                
                    <p>
                        A Cinthya Picado y Karen Corrales, por brindar siempre 
                        la información necesaria para que todo funcionara. Además
                        de ser excelentes personas y buenas compañeras de trabajo.
                    </p>
                    ...
                    <p>
                        Nancy, Zully, María, Paola, Ilse, Dixiana, Katherine
                    </p>
                </div>
            </section>
...
<script src="{!! asset('js/agradecimiento.js') !!}"></script>
